...
from exarth_rest_auth.serializers import PasswordChangeSerializer, UserDetailsSerializer
from exarth_rest_auth.registration.serializers import SocialLoginSerializer
...
validator_path = 'exarth_rest_auth.tests.test_serializers.custom_username_validators'
