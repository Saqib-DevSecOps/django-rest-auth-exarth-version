...
from exarth_rest_auth.registration.views import (
...
from exarth_rest_auth.social_serializers import (
    TwitterConnectSerializer, TwitterLoginSerializer,
)
from exarth_rest_auth.urls import urlpatterns
...
urlpatterns += [
    re_path(r'^rest-registration/', include('exarth_rest_auth.registration.urls')),
