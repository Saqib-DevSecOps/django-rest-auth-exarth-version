...
from exarth_rest_auth.registration.app_settings import register_permission_classes
from exarth_rest_auth.registration.views import RegisterView
from exarth_rest_auth.models import get_token_model
